...
var GoogleMapsAPIWrapper = (function () {
    ...
    GoogleMapsAPIWrapper.prototype.getMapTypeId = function () { return this._map.then(function (map) { return map.getMapTypeId(); }); };
    ...
    */
    GoogleMapsAPIWrapper.prototype.getLatLong = function (address) {
...
var AgmMap = (function () {
    function AgmMap(_elem, _mapsWrapper) {
         ...
         */
        this.mapTypeChange = new _angular_core.EventEmitter();
    }
    /** @internal */
    ...
    AgmMap.prototype._handleMapTypeChange = function () {
        var _this = this;
        var s = this._mapsWrapper.subscribeToMapEvent('maptypeid_changed').subscribe(function () {
            _this._mapsWrapper.getMapTypeId().then(function (maptype) {
                _this.mapTypeId = maptype;
                _this.mapTypeChange.emit(maptype);
            });
        });
        this._observableSubscriptions.push(s);
    };
...
AgmMap.propDecorators = {
    ...
    'mapTypeChange': [{ type: _angular_core.Output },],
};
...
var AgmChild = (function () {
    function AgmChild(gMaps) {
        this.gMaps = gMaps;
        this.onMapLoad = new _angular_core.EventEmitter();
    }
...
AgmChild.propDecorators = {
    'onMapLoad': [{ type: _angular_core.Output },],
};
